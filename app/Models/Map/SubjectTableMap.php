...
class SubjectTableMap extends TableMap
{
     ...
     */
    const COL_NAME = 'subject.name';

    /**
     * the column name for the code field
     */
    const COL_CODE = 'subject.code';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Code', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'code', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SubjectTableMap::COL_ID, SubjectTableMap::COL_NAME, SubjectTableMap::COL_CODE, SubjectTableMap::COL_CREATED_AT, SubjectTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'code', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Code' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'code' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SubjectTableMap::COL_ID => 0, SubjectTableMap::COL_NAME => 1, SubjectTableMap::COL_CODE => 2, SubjectTableMap::COL_CREATED_AT => 3, SubjectTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'code' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
...
), 'CASCADE', null, 'StudyPrograms', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SubjectTableMap::COL_NAME);
            $criteria->addSelectColumn(SubjectTableMap::COL_CODE);
