...
class ProfessorTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Professor';
     ...
     */
    const COL_FIRST_NAME = 'professor.first_name';

    /**
     * the column name for the last_name field
     */
    const COL_LAST_NAME = 'professor.last_name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'professor.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'professor.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ProfessorTableMap::COL_ID, ProfessorTableMap::COL_FIRST_NAME, ProfessorTableMap::COL_LAST_NAME, ProfessorTableMap::COL_CREATED_AT, ProfessorTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ProfessorTableMap::COL_ID => 0, ProfessorTableMap::COL_FIRST_NAME => 1, ProfessorTableMap::COL_LAST_NAME => 2, ProfessorTableMap::COL_CREATED_AT => 3, ProfessorTableMap::COL_UPDATED_AT => 4, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Professor');
        $this->setPackage('');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to professor     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProfessorTableMap::COL_FIRST_NAME);
            $criteria->addSelectColumn(ProfessorTableMap::COL_LAST_NAME);
            $criteria->addSelectColumn(ProfessorTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(ProfessorTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Professor) { // it's a model object
