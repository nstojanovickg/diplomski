...
class CourseTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Course';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CourseTableMap::COL_ID, CourseTableMap::COL_NAME, CourseTableMap::COL_CREATED_AT, CourseTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CourseTableMap::COL_ID => 0, CourseTableMap::COL_NAME => 1, CourseTableMap::COL_CREATED_AT => 2, CourseTableMap::COL_UPDATED_AT => 3, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Course');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Course) { // it's a model object
