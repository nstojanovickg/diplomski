...
/**
 * Base class that represents a row from the 'study_program' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class StudyProgram implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\StudyProgramTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\StudyProgram object.
     */
    ...
    /**
     * Compares this with another <code>StudyProgram</code> instance.  If
     * <code>obj</code> is an instance of <code>StudyProgram</code>, delegates to
     * <code>equals(StudyProgram)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|StudyProgram The current object, for fluid interface
     */
    ...
    public function setSubjectId($v)
    {
        ...
        if ($this->subject_id !== $v) {
            $this->subject_id = $v;
            $this->modifiedColumns[StudyProgramTableMap::COL_SUBJECT_ID] = true;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[StudyProgramTableMap::COL_COURSE_ID] = true;
        }
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== $v) {
            $this->year = $v;
            $this->modifiedColumns[StudyProgramTableMap::COL_YEAR] = true;
        }
    ...
    public function setSemester($v)
    {
        ...
        if ($this->semester !== $v) {
            $this->semester = $v;
            $this->modifiedColumns[StudyProgramTableMap::COL_SEMESTER] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[StudyProgramTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[StudyProgramTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StudyProgramTableMap::translateFieldName('SubjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subject_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StudyProgramTableMap::translateFieldName('CourseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->course_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StudyProgramTableMap::translateFieldName('Year', TableMap::TYPE_PHPNAME, $indexType)];
            $this->year = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StudyProgramTableMap::translateFieldName('Semester', TableMap::TYPE_PHPNAME, $indexType)];
            $this->semester = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StudyProgramTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : StudyProgramTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = StudyProgramTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\StudyProgram'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStudyProgramQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see StudyProgram::setDeleted()
     * @see StudyProgram::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStudyProgramQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(StudyProgramTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(StudyProgramTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(StudyProgramTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                StudyProgramTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StudyProgramTableMap::COL_SUBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'subject_id';
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'course_id';
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_YEAR)) {
            $modifiedColumns[':p' . $index++]  = 'year';
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_SEMESTER)) {
        ...
        $sql = sprintf(
            'INSERT INTO study_program (%s) VALUES (%s)',
    ...
    {
        $pos = StudyProgramTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['StudyProgram'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StudyProgram'][$this->hashCode()] = true;
        $keys = StudyProgramTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSubjectId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\StudyProgram
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\StudyProgram The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StudyProgramTableMap::COL_SUBJECT_ID)) {
            $criteria->add(StudyProgramTableMap::COL_SUBJECT_ID, $this->subject_id);
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_COURSE_ID)) {
            $criteria->add(StudyProgramTableMap::COL_COURSE_ID, $this->course_id);
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_YEAR)) {
            $criteria->add(StudyProgramTableMap::COL_YEAR, $this->year);
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_SEMESTER)) {
            $criteria->add(StudyProgramTableMap::COL_SEMESTER, $this->semester);
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_CREATED_AT)) {
            $criteria->add(StudyProgramTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(StudyProgramTableMap::COL_UPDATED_AT)) {
            $criteria->add(StudyProgramTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildStudyProgramQuery::create();
        $criteria->add(StudyProgramTableMap::COL_SUBJECT_ID, $this->subject_id);
        $criteria->add(StudyProgramTableMap::COL_COURSE_ID, $this->course_id);
    ...
    {
        return (null === $this->getSubjectId()) && (null === $this->getCourseId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\StudyProgram (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\StudyProgram Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCourse(ConnectionInterface $con = null)
    {
        if ($this->aCourse === null && ($this->course_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addStudyPrograms($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StudyProgramTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildStudyProgram The current object (for fluent API support)
     */
