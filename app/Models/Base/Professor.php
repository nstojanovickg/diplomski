...
abstract class Professor implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\ProfessorTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Professor object.
     */
     ...
     * @return $this|\App\Models\Professor The current object (for fluent API support)
     */
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[ProfessorTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[ProfessorTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ProfessorTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ProfessorTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProfessorTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProfessorTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProfessorTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProfessorTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = ProfessorTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Professor'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProfessorTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProfessorTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProfessorTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProfessorTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(ProfessorTableMap::COL_LAST_NAME)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Professor
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Professor The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfessorTableMap::COL_FIRST_NAME)) {
            $criteria->add(ProfessorTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(ProfessorTableMap::COL_LAST_NAME)) {
            $criteria->add(ProfessorTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(ProfessorTableMap::COL_CREATED_AT)) {
            $criteria->add(ProfessorTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ProfessorTableMap::COL_UPDATED_AT)) {
            $criteria->add(ProfessorTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Professor (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Professor Clone of current object.
     * @throws PropelException
     */
    ...
    public function setAdminUsers(Collection $adminUsers, ConnectionInterface $con = null)
    {
        ...
        foreach ($adminUsersToDelete as $adminUserRemoved) {
            $adminUserRemoved->setProfessor(null);
        }
    ...
    public function setEngagements(Collection $engagements, ConnectionInterface $con = null)
    {
        ...
        $this->engagementsScheduledForDeletion = $engagementsToDelete;

        foreach ($engagementsToDelete as $engagementRemoved) {
            $engagementRemoved->setProfessor(null);
        }
