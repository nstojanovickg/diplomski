...
/**
 * Base class that represents a row from the 'proffesor' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Proffesor implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\ProffesorTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Proffesor object.
     */
    ...
    /**
     * Compares this with another <code>Proffesor</code> instance.  If
     * <code>obj</code> is an instance of <code>Proffesor</code>, delegates to
     * <code>equals(Proffesor)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Proffesor The current object, for fluid interface
     */
     ...
     * @return $this|\App\Models\Proffesor The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProffesorTableMap::COL_ID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[ProffesorTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[ProffesorTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ProffesorTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ProffesorTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProffesorTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProffesorTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProffesorTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProffesorTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProffesorTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = ProffesorTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Proffesor'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProffesorQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Proffesor::setDeleted()
     * @see Proffesor::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProffesorQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProffesorTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProffesorTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProffesorTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ProffesorTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ProffesorTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ProffesorTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ProffesorTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ProffesorTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(ProffesorTableMap::COL_LAST_NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO proffesor (%s) VALUES (%s)',
    ...
    {
        $pos = ProffesorTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Proffesor'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Proffesor'][$this->hashCode()] = true;
        $keys = ProffesorTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Proffesor
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Proffesor The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(ProffesorTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ProffesorTableMap::COL_ID)) {
            $criteria->add(ProffesorTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ProffesorTableMap::COL_FIRST_NAME)) {
            $criteria->add(ProffesorTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(ProffesorTableMap::COL_LAST_NAME)) {
            $criteria->add(ProffesorTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(ProffesorTableMap::COL_CREATED_AT)) {
            $criteria->add(ProffesorTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ProffesorTableMap::COL_UPDATED_AT)) {
            $criteria->add(ProffesorTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildProffesorQuery::create();
        $criteria->add(ProffesorTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Proffesor (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Proffesor Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildProffesor is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildProffesor The current object (for fluent API support)
     */
    public function setEngagements(Collection $engagements, ConnectionInterface $con = null)
    {
        ...
        foreach ($engagementsToDelete as $engagementRemoved) {
            $engagementRemoved->setProffesor(null);
        }
     ...
     * Otherwise if this Proffesor is new, it will return
     * an empty collection; or if this Proffesor has previously
     * been saved, it will retrieve related Engagements from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Proffesor.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProffesorTableMap::DEFAULT_STRING_FORMAT);
    }
