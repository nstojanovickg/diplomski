...
/**
 * Base class that represents a row from the 'engagement' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Engagement implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\EngagementTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Engagement object.
     */
    ...
    /**
     * Compares this with another <code>Engagement</code> instance.  If
     * <code>obj</code> is an instance of <code>Engagement</code>, delegates to
     * <code>equals(Engagement)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Engagement The current object, for fluid interface
     */
     ...
     * @return $this|\App\Models\Engagement The current object (for fluent API support)
     */
    public function setProfessorId($v)
    {
        ...
        if ($this->professor_id !== $v) {
            $this->professor_id = $v;
            $this->modifiedColumns[EngagementTableMap::COL_PROFESSOR_ID] = true;
        }
    ...
    public function setSubjectId($v)
    {
        ...
        if ($this->subject_id !== $v) {
            $this->subject_id = $v;
            $this->modifiedColumns[EngagementTableMap::COL_SUBJECT_ID] = true;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[EngagementTableMap::COL_COURSE_ID] = true;
        }
    ...
    public function setSchoolYearId($v)
    {
        ...
        if ($this->school_year_id !== $v) {
            ...
            $this->modifiedColumns[EngagementTableMap::COL_SCHOOL_YEAR_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EngagementTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EngagementTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EngagementTableMap::translateFieldName('ProfessorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->professor_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EngagementTableMap::translateFieldName('SubjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subject_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EngagementTableMap::translateFieldName('CourseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->course_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EngagementTableMap::translateFieldName('SchoolYearId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->school_year_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EngagementTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EngagementTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = EngagementTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Engagement'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEngagementQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Engagement::setDeleted()
     * @see Engagement::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEngagementQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EngagementTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(EngagementTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(EngagementTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                EngagementTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EngagementTableMap::COL_PROFESSOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'professor_id';
        }
        if ($this->isColumnModified(EngagementTableMap::COL_SUBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'subject_id';
        }
        if ($this->isColumnModified(EngagementTableMap::COL_COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'course_id';
        }
        if ($this->isColumnModified(EngagementTableMap::COL_SCHOOL_YEAR_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO engagement (%s) VALUES (%s)',
    ...
    {
        $pos = EngagementTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Engagement
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setProfessorId($arr[$keys[0]]);
        }
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setSchoolYearId($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Engagement The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EngagementTableMap::COL_CREATED_AT)) {
            $criteria->add(EngagementTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(EngagementTableMap::COL_UPDATED_AT)) {
            $criteria->add(EngagementTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function hashCode()
    {
        ...
        //relation fk_en_sb to table subject
        ...
        //relation fk_en_sy to table school_year
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Engagement (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Engagement Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCourse(ConnectionInterface $con = null)
    {
        if ($this->aCourse === null && ($this->course_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCourse->addEngagements($this);
             */
        }
    ...
    public function getProfessor(ConnectionInterface $con = null)
    {
        if ($this->aProfessor === null && ($this->professor_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProfessor->addEngagements($this);
             */
        }
    ...
    public function getSubject(ConnectionInterface $con = null)
    {
        if ($this->aSubject === null && ($this->subject_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSubject->addEngagements($this);
             */
        }
    ...
    public function getSchoolYear(ConnectionInterface $con = null)
    {
        if ($this->aSchoolYear === null && ($this->school_year_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchoolYear->addEngagements($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EngagementTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildEngagement The current object (for fluent API support)
     */
