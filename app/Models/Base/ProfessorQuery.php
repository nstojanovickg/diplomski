...
use App\Models\Map\ProfessorTableMap;
 ...
 * @method     ChildProfessorQuery orderByFirstName($order = Criteria::ASC) Order by the first_name column
 * @method     ChildProfessorQuery orderByLastName($order = Criteria::ASC) Order by the last_name column
 * @method     ChildProfessorQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildProfessorQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method     ChildProfessorQuery groupById() Group by the id column
 * @method     ChildProfessorQuery groupByFirstName() Group by the first_name column
 * @method     ChildProfessorQuery groupByLastName() Group by the last_name column
 * @method     ChildProfessorQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildProfessorQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method     ChildProfessorQuery leftJoinAdminUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the AdminUser relation
 * @method     ChildProfessorQuery rightJoinAdminUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AdminUser relation
 * @method     ChildProfessorQuery innerJoinAdminUser($relationAlias = null) Adds a INNER JOIN clause to the query using the AdminUser relation
 *
 * @method     ChildProfessorQuery leftJoinEngagement($relationAlias = null) Adds a LEFT JOIN clause to the query using the Engagement relation
 * @method     ChildProfessorQuery rightJoinEngagement($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Engagement relation
 * @method     ChildProfessorQuery innerJoinEngagement($relationAlias = null) Adds a INNER JOIN clause to the query using the Engagement relation
 *
 * @method     \App\Models\AdminUserQuery|\App\Models\EngagementQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildProfessor findOneByFirstName(string $first_name) Return the first ChildProfessor filtered by the first_name column
 * @method     ChildProfessor findOneByLastName(string $last_name) Return the first ChildProfessor filtered by the last_name column
 * @method     ChildProfessor findOneByCreatedAt(string $created_at) Return the first ChildProfessor filtered by the created_at column
 * @method     ChildProfessor findOneByUpdatedAt(string $updated_at) Return the first ChildProfessor filtered by the updated_at column *
 ...
 * @method     ChildProfessor requireOneByFirstName(string $first_name) Return the first ChildProfessor filtered by the first_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProfessor requireOneByLastName(string $last_name) Return the first ChildProfessor filtered by the last_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProfessor requireOneByCreatedAt(string $created_at) Return the first ChildProfessor filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProfessor requireOneByUpdatedAt(string $updated_at) Return the first ChildProfessor filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProfessor[]|ObjectCollection findByFirstName(string $first_name) Return ChildProfessor objects filtered by the first_name column
 * @method     ChildProfessor[]|ObjectCollection findByLastName(string $last_name) Return ChildProfessor objects filtered by the last_name column
 * @method     ChildProfessor[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildProfessor objects filtered by the created_at column
 * @method     ChildProfessor[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildProfessor objects filtered by the updated_at column
...
abstract class ProfessorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Models\Base\ProfessorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Models\\Professor', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ProfessorTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    public function filterByFirstName($firstName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProfessorTableMap::COL_FIRST_NAME, $firstName, $comparison);
    }
    ...
    public function filterByLastName($lastName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProfessorTableMap::COL_LAST_NAME, $lastName, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(ProfessorTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(ProfessorTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProfessorTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(ProfessorTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(ProfessorTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProfessorTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByAdminUser($adminUser, $comparison = null)
    {
        if ($adminUser instanceof \App\Models\AdminUser) {
            return $this
                ->addUsingAlias(ProfessorTableMap::COL_ID, $adminUser->getProfessorId(), $comparison);
    ...
    public function filterByEngagement($engagement, $comparison = null)
    {
        if ($engagement instanceof \App\Models\Engagement) {
            return $this
                ->addUsingAlias(ProfessorTableMap::COL_ID, $engagement->getProfessorId(), $comparison);
    ...
    {
        return $this->addUsingAlias(ProfessorTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ProfessorTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ProfessorTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ProfessorTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(ProfessorTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
