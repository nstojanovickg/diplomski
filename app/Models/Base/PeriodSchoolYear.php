...
/**
 * Base class that represents a row from the 'period_school_year' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class PeriodSchoolYear implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\PeriodSchoolYearTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\PeriodSchoolYear object.
     */
    ...
    /**
     * Compares this with another <code>PeriodSchoolYear</code> instance.  If
     * <code>obj</code> is an instance of <code>PeriodSchoolYear</code>, delegates to
     * <code>equals(PeriodSchoolYear)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PeriodSchoolYear The current object, for fluid interface
     */
    ...
    public function setPeriodId($v)
    {
        ...
        if ($this->period_id !== $v) {
            $this->period_id = $v;
            $this->modifiedColumns[PeriodSchoolYearTableMap::COL_PERIOD_ID] = true;
        }
    ...
    public function setSchoolYearId($v)
    {
        ...
        if ($this->school_year_id !== $v) {
            ...
            $this->modifiedColumns[PeriodSchoolYearTableMap::COL_SCHOOL_YEAR_ID] = true;
        }
    ...
    public function setDateStart($v)
    {
        ...
        if ($this->date_start !== null || $dt !== null) {
            if ($this->date_start === null || $dt === null || $dt->format("Y-m-d") !== $this->date_start->format("Y-m-d")) {
                ...
                $this->modifiedColumns[PeriodSchoolYearTableMap::COL_DATE_START] = true;
            }
    ...
    public function setDateEnd($v)
    {
        ...
        if ($this->date_end !== null || $dt !== null) {
            if ($this->date_end === null || $dt === null || $dt->format("Y-m-d") !== $this->date_end->format("Y-m-d")) {
                ...
                $this->modifiedColumns[PeriodSchoolYearTableMap::COL_DATE_END] = true;
            }
        } // if either are not null
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PeriodSchoolYearTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PeriodSchoolYearTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PeriodSchoolYearTableMap::translateFieldName('PeriodId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->period_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PeriodSchoolYearTableMap::translateFieldName('SchoolYearId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->school_year_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PeriodSchoolYearTableMap::translateFieldName('DateStart', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_start = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PeriodSchoolYearTableMap::translateFieldName('DateEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date_end = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PeriodSchoolYearTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PeriodSchoolYearTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = PeriodSchoolYearTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\PeriodSchoolYear'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPeriodSchoolYearQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PeriodSchoolYear::setDeleted()
     * @see PeriodSchoolYear::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPeriodSchoolYearQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PeriodSchoolYearTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PeriodSchoolYearTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PeriodSchoolYearTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PeriodSchoolYearTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_PERIOD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'period_id';
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_SCHOOL_YEAR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'school_year_id';
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_DATE_START)) {
            $modifiedColumns[':p' . $index++]  = 'date_start';
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_DATE_END)) {
        ...
        $sql = sprintf(
            'INSERT INTO period_school_year (%s) VALUES (%s)',
    ...
    {
        $pos = PeriodSchoolYearTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PeriodSchoolYear'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PeriodSchoolYear'][$this->hashCode()] = true;
        $keys = PeriodSchoolYearTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPeriodId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\PeriodSchoolYear
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setPeriodId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setSchoolYearId($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\PeriodSchoolYear The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_PERIOD_ID)) {
            $criteria->add(PeriodSchoolYearTableMap::COL_PERIOD_ID, $this->period_id);
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_SCHOOL_YEAR_ID)) {
            $criteria->add(PeriodSchoolYearTableMap::COL_SCHOOL_YEAR_ID, $this->school_year_id);
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_DATE_START)) {
            $criteria->add(PeriodSchoolYearTableMap::COL_DATE_START, $this->date_start);
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_DATE_END)) {
            $criteria->add(PeriodSchoolYearTableMap::COL_DATE_END, $this->date_end);
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_CREATED_AT)) {
            $criteria->add(PeriodSchoolYearTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PeriodSchoolYearTableMap::COL_UPDATED_AT)) {
            $criteria->add(PeriodSchoolYearTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPeriodSchoolYearQuery::create();
        $criteria->add(PeriodSchoolYearTableMap::COL_PERIOD_ID, $this->period_id);
        $criteria->add(PeriodSchoolYearTableMap::COL_SCHOOL_YEAR_ID, $this->school_year_id);
    ...
    {
        $validPk = null !== $this->getPeriodId() &&
            null !== $this->getSchoolYearId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation fk_psy_pd to table period
        if ($this->aPeriod && $hash = spl_object_hash($this->aPeriod)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation fk_psy_sy to table school_year
        if ($this->aSchoolYear && $hash = spl_object_hash($this->aSchoolYear)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        $pks = array();
        $pks[0] = $this->getPeriodId();
        $pks[1] = $this->getSchoolYearId();
    ...
    {
        $this->setPeriodId($keys[0]);
        $this->setSchoolYearId($keys[1]);
    }
    ...
    {
        return (null === $this->getPeriodId()) && (null === $this->getSchoolYearId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\PeriodSchoolYear (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\PeriodSchoolYear Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPeriod(ConnectionInterface $con = null)
    {
        if ($this->aPeriod === null && ($this->period_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPeriod->addPeriodSchoolYears($this);
             */
        }
    ...
    public function getSchoolYear(ConnectionInterface $con = null)
    {
        if ($this->aSchoolYear === null && ($this->school_year_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSchoolYear->addPeriodSchoolYears($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PeriodSchoolYearTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildPeriodSchoolYear The current object (for fluent API support)
     */
