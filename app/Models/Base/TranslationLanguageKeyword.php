...
/**
 * Base class that represents a row from the 'translation_language_keyword' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class TranslationLanguageKeyword implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\TranslationLanguageKeywordTableMap';
    ...
    /**
     * @var        ChildTranslationKeyword
     */
    protected $aTranslationKeyword;
    ...
    /**
     * Initializes internal state of App\Models\Base\TranslationLanguageKeyword object.
     */
    ...
    /**
     * Compares this with another <code>TranslationLanguageKeyword</code> instance.  If
     * <code>obj</code> is an instance of <code>TranslationLanguageKeyword</code>, delegates to
     * <code>equals(TranslationLanguageKeyword)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TranslationLanguageKeyword The current object, for fluid interface
     */
    ...
    public function setLanguageId($v)
    {
        ...
        if ($this->language_id !== $v) {
            $this->language_id = $v;
            $this->modifiedColumns[TranslationLanguageKeywordTableMap::COL_LANGUAGE_ID] = true;
        }
    ...
    public function setKeywordId($v)
    {
        ...
        if ($this->keyword_id !== $v) {
            $this->keyword_id = $v;
            $this->modifiedColumns[TranslationLanguageKeywordTableMap::COL_KEYWORD_ID] = true;
        }

        if ($this->aTranslationKeyword !== null && $this->aTranslationKeyword->getId() !== $v) {
            $this->aTranslationKeyword = null;
        }
    ...
    public function setTranslation($v)
    {
        ...
        if ($this->translation !== $v) {
            $this->translation = $v;
            $this->modifiedColumns[TranslationLanguageKeywordTableMap::COL_TRANSLATION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TranslationLanguageKeywordTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TranslationLanguageKeywordTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TranslationLanguageKeywordTableMap::translateFieldName('LanguageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->language_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TranslationLanguageKeywordTableMap::translateFieldName('KeywordId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->keyword_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TranslationLanguageKeywordTableMap::translateFieldName('Translation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->translation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TranslationLanguageKeywordTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TranslationLanguageKeywordTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = TranslationLanguageKeywordTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\TranslationLanguageKeyword'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTranslationKeyword !== null && $this->keyword_id !== $this->aTranslationKeyword->getId()) {
            $this->aTranslationKeyword = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTranslationLanguageKeywordQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TranslationLanguageKeyword::setDeleted()
     * @see TranslationLanguageKeyword::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTranslationLanguageKeywordQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TranslationLanguageKeywordTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(TranslationLanguageKeywordTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TranslationLanguageKeywordTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                TranslationLanguageKeywordTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TranslationLanguageKeywordTableMap::COL_LANGUAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'language_id';
        }
        if ($this->isColumnModified(TranslationLanguageKeywordTableMap::COL_KEYWORD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'keyword_id';
        }
        if ($this->isColumnModified(TranslationLanguageKeywordTableMap::COL_TRANSLATION)) {
        ...
        $sql = sprintf(
            'INSERT INTO translation_language_keyword (%s) VALUES (%s)',
    ...
    {
        $pos = TranslationLanguageKeywordTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TranslationLanguageKeyword'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TranslationLanguageKeyword'][$this->hashCode()] = true;
        $keys = TranslationLanguageKeywordTableMap::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aTranslationKeyword) {
                ...
                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = 'translationKeyword';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'translation_keyword';
                        break;
                    default:
                        $key = 'TranslationKeyword';
                }

                $result[$key] = $this->aTranslationKeyword->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\TranslationLanguageKeyword
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setKeywordId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setTranslation($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\TranslationLanguageKeyword The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TranslationLanguageKeywordTableMap::COL_TRANSLATION)) {
            $criteria->add(TranslationLanguageKeywordTableMap::COL_TRANSLATION, $this->translation);
        }
        if ($this->isColumnModified(TranslationLanguageKeywordTableMap::COL_CREATED_AT)) {
            $criteria->add(TranslationLanguageKeywordTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(TranslationLanguageKeywordTableMap::COL_UPDATED_AT)) {
            $criteria->add(TranslationLanguageKeywordTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getLanguageId() &&
            null !== $this->getKeywordId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation fk_tnlnkw_tnkw to table translation_language
        if ($this->aTranslationLanguage && $hash = spl_object_hash($this->aTranslationLanguage)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation fk_tnlnkw_tnln to table translation_keyword
        if ($this->aTranslationKeyword && $hash = spl_object_hash($this->aTranslationKeyword)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        return (null === $this->getLanguageId()) && (null === $this->getKeywordId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\TranslationLanguageKeyword (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\TranslationLanguageKeyword Clone of current object.
     * @throws PropelException
     */
    ...
    public function getTranslationLanguage(ConnectionInterface $con = null)
    {
        if ($this->aTranslationLanguage === null && ($this->language_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTranslationLanguage->addTranslationLanguageKeywords($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TranslationLanguageKeywordTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildTranslationLanguageKeyword The current object (for fluent API support)
     */
